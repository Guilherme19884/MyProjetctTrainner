...
import { AddDateToTrainners1621066270881 } from './migrations/1721134934419-AddDateTrainnersTable'
...
export const AppDataSource = new DataSource({
  ...
  migrations: [CreateUsersTable1720275915716, CreateTrainnersTable1721066270881,AddDateToTrainners1621066270881],
  subscribers: [],
});
